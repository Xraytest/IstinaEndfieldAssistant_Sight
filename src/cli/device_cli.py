...
def _get_touch_manager():
    ...
    try:
        ...
        _logger.warning(LogCategory.ADB, f"TouchManager 连接失败：{e}")
        return None
...
def _get_capture():
    try:
        ...
        _logger.warning(LogCategory.ADB, f"ScreenCapture 初始化失败：{e}")
        return None
...
def cmd_info(args) -> int:
    ...
    try:
        ...
        _logger.debug(LogCategory.ADB, f"获取分辨率失败：{e}")
    ...
    try:
        ...
        _logger.debug(LogCategory.ADB, f"获取 DPI 失败：{e}")
    ...
    try:
        ...
        _logger.debug(LogCategory.ADB, f"获取 Android 版本失败：{e}")
    ...
    try:
        ...
        _logger.debug(LogCategory.ADB, f"获取设备型号失败：{e}")
    ...
    try:
        ...
        _logger.debug(LogCategory.ADB, f"截图能力检测失败：{e}")
