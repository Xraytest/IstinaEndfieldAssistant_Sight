...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_readtask_run_blue = p_readtask_sub.add_parser("run_blue", help="run all blue (minor) tasks with VLM (legacy alias of run_category)")
    p_readtask_run_blue.add_argument("--options", default="{}", help="JSON options")
    p_readtask_run_blue.add_argument("--serial", default=None, help="device serial")
    p_readtask_run_category = p_readtask_sub.add_parser("run_category", help="run tasks of a given category (default: 次要) with VLM + frequent verification")
    p_readtask_run_category.add_argument("--options", default="{}", help="JSON options (category / selected_tasks / TaskExecuteCategory / TaskExecuteVlmMaxStepsValue / ...)")
    p_readtask_run_category.add_argument("--serial", default=None, help="device serial")
    p_readtask_list_categorized = p_readtask_sub.add_parser("list_categorized", help="list tasks grouped by category (进行中/ALL/紧要/重要/次要)")
    p_readtask_list_categorized.add_argument("--options", default="{}", help="JSON options")
    p_readtask_list_categorized.add_argument("--serial", default=None, help="device serial")
    ...
    p_preset_apply.add_argument("--serial", default=None, help="device serial")
    ...
    p_queue_clear = p_queue_sub.add_parser("clear", help="clear queue")
    p_queue_clear.add_argument("--serial", default=None, help="device serial")
